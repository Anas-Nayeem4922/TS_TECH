...
CREATE TABLE "LoyaltyMembership" (
    ...
    CONSTRAINT "LoyaltyMembership_pkey" PRIMARY KEY ("userId")
);
...
-- AddForeignKey
ALTER TABLE "LoyaltyMembership" ADD CONSTRAINT "LoyaltyMembership_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
