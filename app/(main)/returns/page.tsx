            ...
            <div className='max-w-3xl mx-auto px-4 sm:px-6 py-12'>
                ...
                <div className='text-silver-400 space-y-6'>
                    <p>
                        ...
                        If you&apos;re not satisfied, we&apos;re here to help.
                    </p>
                    ...
                    <p>
                        Once we receive and inspect the return, we&apos;ll
                        process your refund within 5–7 business days. Refunds
                        are made to the original payment method.
                    </p>
                    <h2 className='text-white text-xl font-semibold mt-8 mb-3'>
                        How to Return
                    </h2>
