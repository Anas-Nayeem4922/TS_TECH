            ...
            <div className='max-w-3xl mx-auto px-4 sm:px-6 py-12'>
                ...
                <div className='text-silver-400 space-y-6'>
                    ...
                    <p>
                        ...
                        change. We reserve the right to modify prices without
                        prior notice. Orders are confirmed only after payment is
                        processed or COD is confirmed.
                    </p>
                    <h2 className='text-white text-xl font-semibold mt-8 mb-3'>
                        Order Acceptance
                    </h2>
                    <p>
                        ...
                        suspect fraudulent activity, unavailability of stock, or
                        pricing errors.
                    </p>
                    <h2 className='text-white text-xl font-semibold mt-8 mb-3'>
                    ...
                    <p>
                        All content, logos, and trademarks on this website are
                        the property of TS Technology and may not be reproduced
