                ...
                <div className='max-w-4xl mx-auto px-4 sm:px-6 text-center relative'>
                    ...
                    >
                        ...
                        <h1 className='text-4xl sm:text-5xl font-bold text-white mb-6'>
                            About{" "}
                            <span className='gold-text'>TS Technology</span>
                        </h1>
                        <p className='text-silver-400 text-lg leading-relaxed max-w-2xl mx-auto'>
                            Born in the heart of Kolkata, TS Technology is more
                            than a tech destiny— we&apos;re your trusted
                            companion in the digital age. We believe everyone
                            deserves premium tech accessories without breaking
                            the bank.
                        </p>
                    </motion.div>
                </div>
                    ...
                    <div className='grid lg:grid-cols-2 gap-12 items-center'>
                        ...
                        <AnimatedSection>
                            ...
                            <h2 className='text-3xl font-bold text-white mb-4'>
                                Kolkata&apos;s Trusted Tech Partner
                            </h2>
                            <p className='text-silver-400 leading-relaxed mb-4'>
                                Founded in Kolkata, TS Technology was built with
                                a simple mission — to make premium tech
                                accessories accessible to everyone through a
                                seamless online shopping experience. What
                                started as a vision has grown into a trusted
                                destination for customers seeking quality
                                products, competitive prices, and reliable
                                service across India.
                            </p>
                            <p className='text-silver-400 leading-relaxed mb-6'>
                                Our team of tech enthusiasts carefully curates
                                every product in our catalog, partnering
                                directly with trusted manufacturers to ensure
                                exceptional quality while eliminating
                                unnecessary middlemen. This allows us to deliver
                                premium products at unbeatable prices, passing
                            ...
                            <div className='grid grid-cols-3 gap-4'>
                                {[
                                    ...
                                    <div
                                        key={s.label}
                                        className='text-center p-4 card-surface rounded-xl border border-white/6'
                                    >
                                ...
                                {[
                                    {
                                        ...
                                        desc: "All products are sourced directly from authorized distributors.",
                                    },
                                    {
                                        icon: Zap,
                                        title: "Fast Delivery",
                                        desc: "Same-day delivery within Kolkata. Pan-India within 3-5 days.",
                                    },
                                    {
                                        icon: Users,
                                        title: "Expert Guidance",
                                        desc: "Our knowledgeable team helps you find the perfect product for your needs.",
                                    },
                                    {
                                        icon: Shield,
                                        title: "Warranty Support",
                                        desc: "Hassle-free warranty claims and after-sales support for all products.",
                                    },
                                ].map((item) => (
                                    <div
                                        key={item.title}
                                        className='flex items-center gap-4 p-4 card-surface rounded-xl border border-white/5'
                                    >
                                        ...
                                        <div>
                                            ...
                                            <div className='text-md text-silver-500'>
                                                {item.desc}
                                            </div>
                                        </div>
                                    </div>
                ...
                <div className='max-w-2xl mx-auto px-4 sm:px-6 text-center'>
                    <AnimatedSection>
                        ...
                        <p className='text-silver-400 mb-6'>
                            Browse our full collection of premium tech
                            accessories.
                        </p>
                        <div className='flex flex-wrap gap-4 justify-center'>
                            ...
                            <Link
                                href='/contact'
                                className='btn-outline-gold inline-flex items-center gap-2 px-6 py-3 rounded-xl font-semibold'
                            >
                                Get in Touch
                            </Link>
                        </div>
